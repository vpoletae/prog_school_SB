...
class Test_Graph(unittest.TestCase):
    ...
    #     self.assertEqual(len(graph.DepthFirstSearch(0, 2)), 0)
    #
    # def test_dfs_5(self):
    #     graph = SimpleGraph(8)
    #     graph.AddVertex(1)
    ...
    #     graph.AddEdge(4, 3)
    #     # print(graph.m_adjacency)
    #     path = graph.BreadthFirstSearch(0, 4)
    #     self.assertEqual(path[0].Value, 'A')
    #     self.assertEqual(path[1].Value, 'B')
    #     self.assertEqual(path[2].Value, 'E')
    #     self.assertEqual(len(path), 3)
    ...
    def test_weak_vertices(self):
        ...
        self.assertEqual(weak[0].Value, 2)
        self.assertEqual(weak[1].Value, 9)
        graph.AddEdge(1, 4)
        weak = graph.WeakVertices()
        self.assertEqual(len(weak), 1)
        self.assertEqual(weak[0].Value, 9)
        graph.AddEdge(5, 8)
        weak = graph.WeakVertices()
